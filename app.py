...
.stApp {{ background: radial-gradient(1200px 600px at 50% -10%, #1E3047 0%, #152538 55%); }}
...
def style_fig(fig, height=360, legend=True):
    fig.update_layout(
        ...
        hoverlabel=dict(bgcolor="#0C1626", bordercolor="rgba(201,162,39,.45)",
            ...
            if pt:
                fig.add_trace(go.Scatter(
                    ...
                    marker=dict(size=13, color=color, symbol=symbol,
                                line=dict(width=1, color="#152538")),
